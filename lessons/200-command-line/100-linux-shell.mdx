...
excerpt: What is the Linux Shell?
---
...
Let’s jump right in! Depending on the distribution your shell prompt might change, but for tdhe most part it should adhere to the following format:
